...
public class RSM {
    ...
    paillier=_paillier;
          ...
          public void StepOne (){
           ...
           CCC = CCC + D11.T1.bitLength() + D11.T2.bitLength()+ D12.T1.bitLength() + D12.T2.bitLength()+  D11.T3.bitLength()+ D12.T3.bitLength();
          
         } 
   
                    public void StepTwo (){
           
            m1=paillier.WPDecryption2(D11);
            m2=paillier.WPDecryption2(D12); 
            m3=m1.multiply(m2);
